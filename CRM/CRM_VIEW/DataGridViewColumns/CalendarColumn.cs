...
{
	// класс столбца DataGridView
	public class DataGridViewCalendarColumn : DataGridViewColumn
	{
		public DataGridViewCalendarColumn()
				: base(new CalendarColumn())
		{
		}
		...
		public override DataGridViewCell CellTemplate
		{
			...
			set
			{
				...
				if (value != null &&
					!value.GetType().IsAssignableFrom(typeof(CalendarColumn))) {
	...
	public class CalendarColumn : DataGridViewTextBoxCell
	{
	...
	class CalendarEditingControl : DateTimePicker, IDataGridViewEditingControl
	{
		...
		public DateTime? NValue
		{
			...
			{
				val = value;
				Value = value.HasValue ? value.Value : DateTime.Now;
				chType = 1;
